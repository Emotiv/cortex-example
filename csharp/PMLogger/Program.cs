...
namespace PMLogger
{
    class Program
    {
        ...
        const bool ActiveSession = false; // Set to true to use an active session with a license which is required for high performance metrics.
        ...
        static void Main(string[] args)
        {
            ...
            dse.Start("", ActiveSession, WantedHeadsetId);
